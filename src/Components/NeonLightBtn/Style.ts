...
export const ActiveBorder1 = styled.span<StyledProps>`
    position: absolute;
    display: black;
...
export const Button1 = styled(Link)<StyledProps>`
    position: relative;
    ...
    &:hover ${ActiveBorder1}:nth-child(1){ // 버튼의 위쪽 border: ;
        left: 100%;
        transition: 0.5s;
    }
    &:hover ${ActiveBorder1}:nth-child(2){ // 버튼의 오른쪽 border
        top: 100%;
        transition: 0.4s;
        transition-delay: 0.125s;
    }
    &:hover ${ActiveBorder1}:nth-child(3){ // 버튼의 아래쪽 border
        right: 100%;
        transition: 0.5s;
        transition-delay: 0.25s;
    }
    &:hover ${ActiveBorder1}:nth-child(4){ // 버튼의 왼쪽 border
        bottom: 100%;
        transition: 0.4s;
