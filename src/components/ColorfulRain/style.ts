...
export const RainLine = styled.i<StyledProps>`
    ...
    &:nth-of-type(4n){ background: linear-gradient(transparent, #0ff)};
    &:nth-of-type(4n+1){ background: linear-gradient(transparent, #0f0)};
    &:nth-of-type(4n+2){ background: linear-gradient(transparent, #f00)};
    &:nth-of-type(4n+3){ background: linear-gradient(transparent, #ff0)};
